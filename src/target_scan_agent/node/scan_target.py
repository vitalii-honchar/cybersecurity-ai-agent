...
Your mission is to perform a security reconnaissance of the target system.
...
- Perform only the scan operations to get the most valuable information about a system.
...
PREVIOUS TOOL RESULTS (may contain attack tools which are not allowed to be used by you):
{tools_results}
"""
