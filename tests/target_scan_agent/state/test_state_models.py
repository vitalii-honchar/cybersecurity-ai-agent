...
class TestStateModels:
    ...
    def test_target_serialization_basic(self):
        ...
        assert dict_result["description"] == "Test web application for security assessment"
    ...
    def test_target_scan_serialization_full(self):
        ...
        assert dict_result["description"] == "Found sensitive directories accessible without authentication"
    ...
    def test_target_scan_round_trip_serialization(self):
        ...
        # Deserialize back
        loaded_dict = json.loads(json_str)
        reconstructed = TargetScan.model_validate(loaded_dict)
    ...
    def test_special_characters_serialization(self):
        ...
        reconstructed_scan = TargetScan.model_validate(scan_dict)
